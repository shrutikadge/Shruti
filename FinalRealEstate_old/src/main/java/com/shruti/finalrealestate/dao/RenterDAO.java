...
public class RenterDAO extends UserDAO{
    ...
    public Person get(String userName,String password)
           {
    		...
    		Renter p=(Renter)crit.uniqueResult();
    		return p;
    	}
    ...
    public Person create(String emailId, String userName,String password, String personType)
        ...
        try {
            ...
            Person user = new Renter(emailId, userName,password, personType);
    ...
    public void delete(Renter agent)
            throws AdException {
        try {
            begin();
