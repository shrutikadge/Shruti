...
//        for (Customer person : organization.getPersonDirectory().getEmployeeList()){
...
//            for(PowerStationAdmin p:organization.getPersonDirectory().getEmployeeList()){
//                Object[] row=new Object[2];
//                row[0] = p.getId();
//                row[1]=p.getName();
//                model.addRow(row);
//            }
   //     }
   //     else{
            for(Person p:organization.getPersonDirectory().getEmployeeList()){
                Object[] row=new Object[2];
                row[0] = p.getId();
                row[1]=p.getName();
                model.addRow(row);
    ...
    private void initComponents() {
        ...
        addJButton.setText("Create Person Profile");
...
//        if(organization instanceof ProviderOrganization)
//        {
//        organization.getcDirectory().createCust(name);
//        }
//        else if(organization instanceof PowerStationOrganization)
//        {
//            organization.getpDir().createPowerStationAdmin(name);
//        }
//        else {
